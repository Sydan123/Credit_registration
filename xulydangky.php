...
// Nếu không phải là sự kiện đăng ký thì không xử lý
    ...
    if (mysqli_num_rows(mysqli_query($conn,"SELECT username FROM sinhvien WHERE username='$username'")) > 0)
    {
    	...
    	$sql = "INSERT INTO sinhvien (masinhvien,username,password,hoten,ngaysinh,lop,quequan,gioitinh,email)
    			VALUES ('$masinhvien','$username','$password','$hoten','$ngaysinh','$lop','$quequan','$gioitinh','$email') ";
